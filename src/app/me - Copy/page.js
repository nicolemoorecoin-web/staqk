      ...
      <div className="max-w-xl mx-auto px-4 pt-8">
        ...
        <section className="mt-6 bg-[#151a28] rounded-2xl border border-blue-900/30 shadow-xl overflow-hidden">
          ...
          <ul className="divide-y divide-blue-900/20">
            <LinkRow
              title="Widgets"
              icon={<FiGrid className="text-gray-400" />}
        ...
        <Link
          href="/auth/signout"
          className="mt-6 w-full bg-[#171c2b] hover:bg-[#11182a] text-red-300 font-semibold py-3 rounded-2xl border border-red-500/20 flex items-center justify-center gap-2"
        >
          <FiLogOut />
          Log Out
        </Link>
...
function RowShell({ children, href }) {
  ...
  return (
    <Cmp
      {...props}
      className={`px-4 py-3 flex items-center gap-3 ${href ? "cursor-pointer active:opacity-90" : ""}`}
    >
      {children}
